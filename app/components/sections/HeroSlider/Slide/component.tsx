...
const Slide: React.FC<SlideProps> = (props) => {
  return (
    <div className="relative flex h-full w-full flex-col gap-8 transition duration-500">
      <div className="relative mt-4 min-h-[15rem] max-w-[22.625rem] sm:min-h-[28.75rem] sm:max-w-[56.25rem] 2xl:max-w-full">
        ...
        <span
          className={`text-neutral-150 absolute right-5 top-0 text-end font-robotoSlab text-[200px] min-[350px]:text-[15.625rem] font-medium leading-[15.625rem] ${
