...
<>
  ...
  <p>
    This Cookie Policy explains how Anita Surma und Michael Szczerbak Netz GbR
    Company uses cookies and similar technologies to recognize you when you
  ...
  <p>
    ...
    as to provide reporting information. Cookies set by the website owner (in
    this case, Anita Surma und Michael Szczerbak Netz GbR are called
  ...
  <p>
    ...
    rejected as they are strictly necessary to provide you with services. The
    ...
    refuse cookies. The specific types of first- and third-party cookies served
    through our Website and the purposes they perform are described in the table
    below (please note that the specific  cookies served may vary depending on
    the specific Online Properties you visit) Unclassified cookies: These are
    cookies that have not yet been categorized. We are in the process of
    classifying these cookies with the help of their providers. i18nextLng
    Purpose: Provider: Service: Type: html_local_storage Expires in: persistent
    Name: i18next Purpose: Provider: Service: Type: Expires in: session
  </p>
  ...
  <p>
    ...
    visit: Digital Advertising Alliance Digital Advertising Alliance of Canada
  ...
  <p>
    ...
    for other site operations. If you do not want Flash Cookies stored on your
    ...
    Panel You can also control Flash Cookies by going to the Global Storage
    Settings Panel following the instructions (which may include instructions
    ...
    by the operator of the page you are on at the time). Please note that
    setting the Flash Player to restrict or limit acceptance of Flash Cookies
    may reduce or impede the functionality of some Flash applications,
    including, potentially, Flash applications used in connection with our
  ...
  <p>
    ...
    stay informed about our use of cookies and related technologies. The date at
    the top of this Cookie Policy indicates when it was last updated.
  </p>
  ...
  <p>
    ...
    please email us at anita.surma@direkt-netz.de or by post to:
  </p>
  <address>
