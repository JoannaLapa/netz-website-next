        ...
        <Wrapper element="div" variant="section">
          <Container variant="sectionSmall">
            ...
            <p>
              ...
              accept or refuse cookies. The specific types of first- and
              third-party cookies served through our Website and the purposes
              ...
              Online Properties you visit) Unclassified cookies: These are
              cookies that have not yet been categorized. We are in the process
              of classifying these cookies with the help of their providers.
              i18nextLng Purpose: Provider: Service: Type: html_local_storage
              Expires in: persistent Name: i18next Purpose: Provider: Service:
              Type: Expires in: session
            </p>
            ...
            <p>
              ...
              information, please visit: Digital Advertising Alliance Digital
              Advertising Alliance of Canada European Interactive Digital
            ...
            <p>
              ...
              do not want Flash Cookies stored on your computer, you can adjust
              the settings of your Flash player to block Flash Cookies storage
              ...
              Settings Panel following the instructions (which may include
              ...
              by the operator of the page you are on at the time). Please note
            ...
            <p>
              ...
              technologies, please email us at anita.surma@direkt-netz.de or by
              post to:
            </p>
            <address>
              Anita Surma und Michael Szczerbak Netz GbR Im Weimer 8, 61137
              Schöneck, Germany Schöneck Hessen 61137 Germany Phone: (+49)176 22
              0 44
            </address>
