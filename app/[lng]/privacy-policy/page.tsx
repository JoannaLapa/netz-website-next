...
export default async function Page({
  ...
  const { t, i18n } = await useTranslation(lng, 'privactyPolicy');

  return (
    <>
    <Header lng={lng} homeLink={t('homeLink')}/>
    <main className="lg:pt-[120px]">
      <Wrapper element="div" variant="section">
        <Container variant="section">
          ...
          <p>
            This privacy notice for Anita Surma und Michael Szczerbak Netz GbR,
          ...
          <ul>
            <li>
              ...
              <Link href="https://netz-website-next.vercel.app">
          ...
          <p>
            ...
            anita.surma@direkt-netz.de.
          </p>
          <Heading title="Summary of key points" />
          <strong>
          ...
          <p>
            ...
            when and with whom we share your personal information How do we keep
            your information safe? We have organisational and technical
          ...
          <p>
            ...
            about what we do with any information we collect? 
          </p>
          <Heading title="1. WHAT INFORMATION DO WE COLLECT?" />
          <p>
            ...
            personal information we collect may include the following: contact
            or authentication dataspanul mailing addresses company names
          ...
          <Heading title="2. HOW DO WE PROCESS YOUR INFORMATION?" />
          <p>
            ...
            interact with our Services, including: To deliver and facilitate
            delivery of services to the user. We may process your information to
            provide you with the requested service. To respond to user
            ...
            have with the requested service. To send administrative information
            to you. We may process your information to send you details about
            our products and services, changes to our terms and policies, and
            other similar information. To fulfil and manage your orders. We may
            process your information to fulfil and manage your orders, payments,
            returns, and exchanges made through the Services. To enable
            ...
            another user. To save or protect an individual&apos;s vital
          ...
          <Heading title="3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?" />
          <p>
            ...
            legitimate business interests. The General Data Protection
            Regulation (GDPR) and UK GDPR require us to explain the valid legal
            bases we rely on in order to process your personal information. As
            such, we may rely on the following legal bases to process your
            personal information: Consent. We may process your information if
            ...
            any time. Learn more about Performance of a Contract. We may process
            your personal information when we believe it is necessary to fulfil
            our contractual obligations to you, including providing our Services
            or at your request prior to entering into a contract with you. We
          ...
          <Heading title="4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?" />
          <p>
            In Short: We may share information in specific situations described
            in this section and/or with the following third parties. Vendors,
            ...
            or agents (&apos;third parties&apos;) who perform services for us or
            ...
            for the period we instruct. The third parties we may share personal
            information with are as follows: Communicate and Chat with Users
            EmailJS Pte. Ltd. Website Hosting cyber_Folks S.A. We also may need
          ...
          <Heading title="DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?" />
          <p>
            ...
            our Cookie Notice:
            https://app.termly.io/dashboard/website/3035073/cookie-policy.
          </p>
          <Heading title=" 6. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?" />
          <p>
            We may transfer, store, and process your information in countries
            other than your own. Our servers are located in If you are accessing
            ...
            accordance with this privacy notice and applicable law. European
            Commission&apos;s Standard Contractual Clauses: We have implemented
            measures to protect your personal information, including by using
            the European Commission&apos;s Standard Contractual Clauses for
            transfers of personal information between our group companies and
          ...
          <Heading title="7. HOW LONG DO WE KEEP YOUR INFORMATION?" />
          <p>
          ...
          <Heading title="8. HOW DO WE KEEP YOUR INFORMATION SAFE?" />
          <p>
          ...
          <Heading title=" 9. DO WE COLLECT INFORMATION FROM MINORS?" />
          <p>
            ...
            contact us at anita.surma@direkt-netz.de.
          </p>
          <Heading title="10. WHAT ARE YOUR PRIVACY RIGHTS?" />
          <p>
            ...
            regions (like the EEA, UK, and Switzerland), you have certain rights
            ...
            UK data protection authority. If you are located in Switzerland, you
            may contact the Federal Data Protection and Information
            Commissioner. Withdrawing your consent: If we are relying on your
            ...
            Cookie Notice:
            https://app.termly.io/dashboard/website/3035073/cookie-policy. If
            you have questions or comments about your privacy rights, you may
            email us at anita.surma@direkt-netz.de.
          </p>
          <Heading title="11. Controls for Do-Not-Track Features" />
          <p>
          ...
          <Heading title="12. Do we make updates to this notice?" />
          <p>
          ...
          <Heading title="How can you contact us about this notice?" />
          <p>
            If you have questions or comments about this notice, you may email
            us at anita.surma@direkt-netz.de or contact us by post at:
          </p>
          <address>
            Anita Surma und Michael Szczerbak Netz GbR Im Weimer 8, 61137
            Schöneck, Germany Schöneck, Hessen, 61137 Germany
          </address>
          <Heading title="How can you review, update, or delete the data we collect from you?" />
          <p>
            You have the right to request access to the personal information we
            collect from you, change that information or delete it. You can
            contact us at anita.surma@direkt-netz.de to request to review,
            update or delete your personal information.
          </p>
          <p>
            The Privacy Policy was created by{' '}
